...
int utn_getFloat(float * pNumeroFlotante, char * mensaje)
{
	...
	if(auxNumeroFlotante > 0)
	{
		*pNumeroFlotante = auxNumeroFlotante;
		retorno = 0;
	}
...
// verificando que la opción ingresada sea la correcta.
	if(auxDelMenuIngresado > 0 && auxDelMenuIngresado < 5){
		*pMenuIngresado = auxDelMenuIngresado;
		retorno = 0;
	}
	else{
		while(auxDelMenuIngresado <1 || auxDelMenuIngresado > 4){
